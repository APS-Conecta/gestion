...
| `logoheader` | `occ theming:config` | `core/img/logo/logo-header.svg` | Header. Full lockup — `server.css` widens the slot from 62×44 to 200×44 and adds the INICIO label |
