---
title: "Ley N° 19.628 — Sobre protección de la vida privada (base de datos personales de Chile)"
norma_id: 141599
source_ssot: "https://www.bcn.cl/leychile/navegar?idNorma=141599"
source_fetched: "https://www.leychile.cl/Consulta/obtxml?opt=7&idNorma=141599"
consolidated_version: "2022-11-10"
status: reference-copy
relationship: >
  Base law. Ley N° 21.719 (idNorma 1209272) sustituye/reescribe extensamente esta ley — incluido su
  nombre, que pasa a ser "sobre protección de LOS DATOS PERSONALES" — con vigencia 01-DIC-2026.
  Este archivo es la versión CONSOLIDADA VIGENTE HOY (previa a 21.719). Desde el 01-DIC-2026 el texto
  operativo de la 19.628 es el resultante de las modificaciones de la 21.719 (ver ley-21719-datos-personales.md).
note: >
  Full text extracted from the official BCN Ley Chile XML web service and converted to Markdown.
  The BCN page (source_ssot) is the legal SSOT. Per-app obligation → design mappings live with each app
  (e.g. ../apps/libro-actas/compliance-ley-21719.md).
---

> **Reference copy — not the legal SSOT.** Authoritative text: BCN
> ([idNorma 141599](https://www.bcn.cl/leychile/navegar?idNorma=141599)). This is the **pre-21.719**
> consolidated text (version 2022-11-10). From **01-DIC-2026** the operative 19.628 text is the one
> produced by Ley 21.719 — compliance work should target the 21.719 text.
...
Han de ser modificados cuando sean erró
...
estuvieren caducos.
Igual exigencia de eliminación, o la de bloqueo de los
datos, en su caso, podrá hacer cuando haya proporcionado
voluntariamente sus datos personales o ellos se usen para
comunicaciones comerciales y no desee continuar figurando en
el registro respectivo, sea de modo definitivo o temporal.
En el caso de los incisos anteriores, la información,
modificación o eliminación de los datos serán
absolutamente gratuitas, debiendo proporcionarse, además, a
solicitud del titular, copia del registro alterado en la
parte pertinente. Si se efectuasen nuevas modificaciones o
...
educacional formal en cualquiera de sus niveles; ni las
deudas contraídas con prestadores de salud públicos o
privados y empresas relacionadas, sean instituciones
financieras, casas comerciales u otras similares, en el
marco de una atención o acción de salud ambulatoria,
hospitalaria o de emergencia sean éstas consultas,
procedimientos, exámenes, programas, cirugías u
operaciones; tampoco podrán comunicarse las deudas
contraídas con concesionarios de autopistas por el uso de
su infraestructura.
...
Artículo 24.- Agrégase los siguientes incisos segundo
y tercero, nuevos, al artículo 127 del Código Sanitario:
''Las recetas médicas y análisis o exámenes de
laboratorios clínicos y servicios relacionados con la salud
son reservados. Sólo podrá revelarse su contenido o darse
copia de ellos con el consentimiento expreso del paciente,
otorgado por escrito. Quien divulgare su contenido
indebidamente, o infringiere las disposiciones del inciso
...
farmacias consignará el nombre de los pacientes
destinatarios de las recetas, ni el de los médicos que las
...
Hacienda N° 950, de 1928, seguirán aplicándose en todo lo
que no sean contrarias a las disposiciones de esta ley.''.

Habiéndose cumplido con lo establecido en el N° 1º
...
Proyecto de ley sobre protección de datos de carácter
personal
...
control de la constitucionalidad de su artículo 16; y que
por sentencia de 4 de agosto de 1999, declaró:

1. Que los preceptos contenidos en el artículo 16, del
proyecto sometido a control, son constitucionales en el
entendido que deben interpretarse en conformidad con lo que
se ha señalado en el considerando 7º de esta sentencia.
2. Que las disposiciones contempladas en el artículo 19
del proyecto sometido a control, son constitucionales.
