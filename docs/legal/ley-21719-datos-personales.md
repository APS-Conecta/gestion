---
title: "Ley N° 21.719 — Regula la protección y el tratamiento de los datos personales y crea la Agencia de Protección de Datos Personales"
norma_id: 1209272
source_ssot: "https://www.bcn.cl/leychile/navegar?idNorma=1209272"
source_fetched: "https://www.leychile.cl/Consulta/obtxml?opt=7&idNorma=1209272"
published_diario_oficial: "2024-12-13"
...
note: >
  ...
  This is a working reference copy for compliance analysis — the BCN page (source_ssot) is the
  legal SSOT. Inline HTML/formatting was stripped; article numbering is preserved verbatim.
  Per-app obligation → design mappings live with each app (e.g.
  ../apps/libro-actas/compliance-ley-21719.md); this file is the suite-wide reference text.
---

> **Reference copy — not the legal SSOT.** The authoritative text lives at BCN
> ([idNorma 1209272](https://www.bcn.cl/leychile/navegar?idNorma=1209272)). Enters into force
> **01-DIC-2026** (art. primero transitorio: primer día del mes vigésimo cuarto tras la publicación
> del 13-DIC-2024).
...
la ley N° 20.285, los organismos pú
...
respectivo informe de la Agencia.
...
Artículo quinto.- Los órganos públicos que
